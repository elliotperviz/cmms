...
If we wish to measure equilibrium properties, we **must** ensure the system is suitably equilibrated over the duration of the measurement. In practice, this means that each configuration in the dynamical trajectory during the measurement will sampling the chosen statistical ensemble. How can we ensure this?
